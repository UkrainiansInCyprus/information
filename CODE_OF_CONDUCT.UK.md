...
[English version of this information](CODE_OF_CONDUCT.md)
...
Про випадки образливої, агресивної чи іншої неприйнятної поведінки можна повідомляти лідерам спільноти, відповідальним за дотримання правил, у наступні способи:
- [GitHub Discussions](https://github.com/UkrainiansInCyprus/information/discussions/categories/code-of-conduct-violations) ⚠️ Публічна платформа ⚠️;
- [GitHub Issues](https://github.com/UkrainiansInCyprus/information/issues) ⚠️ Публічна платформа ⚠️;
- Електронна пошта: [conduct@pavp.pp.ua](mailto:conduct@pavp.pp.ua);
- Прямі повідомлення лідерам спільноти (через електронну пошту/інші контактні дані, зазначені у їхніх профілях).
...
### Повідомлення про зміни внесені до Кодексу поведінки

Дещо модифіковано для відображення особистих стилістичних уподобань (додано `;` та явне `не обмежується` у списках, додано `...` наприкінці деяких речень), а також розширено розділ "Забезпечення дотримання" для включення кількох способів повідомлення про інциденти.